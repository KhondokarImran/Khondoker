#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To KHONDOKAR-IMRAN 
...
\033[1;96m▇▇┈┈┈┈┈┈┈┈┈┈┈┈┈┈▇▇ 🌺\033[1;91m 🌹 ▇▇┈┈┈┈┈┈┈┈┈┈┈┈┈┈▇▇
\033[1;96m▇▇┈┈┈┈┈┈┈┈┈┈┈┈┈┈▇▇▇▇\033[1;91m▇▇▇▇▇┈┈┈┈┈┈┈┈┈┈┈┈┈┈▇▇
\033[1;93m▇▇ FB link ▇▇\033[1;93m     ▇▇Khondokar.Imran273   ▇▇
\033[1;95m«-----------------\033[1;91mKHONDOKAR-IMRAN\033[1;95m-----------------»"""
logo3 = """
\033[1;93m▇▇ Fb link ▇▇\033[1;93m     ▇▇Khondokar.Imran273   ▇▇"
___________________$$$$$$
...
\033[1;95m«-----------------\033[1;9mKHONDOKAR-IMRAN H\033[1;95m-----------------»"""
logo7 = """
...
def pilih():
	...
	if unikers =="":
		...
		print "\033[1;95m«-----------------\033[1;91mMessage\033[1;95m-----------------»"
                ...
                jalan("\033[1;96mgit clone https://github.com/KhondokarImran/Khondoker.git")
                jalan('\033[1;96mcd Khondoker')
                jalan('\033[1;96mpython2 Khondoker.py')
...
def pilih_crack():
	...
	print '\033[1;95mProcess Has Been Completed Press➡ Type 0 Enter↩ Next Type 0 (logout)↩\033[1;97m....'
        print '\033[1;95mNext Type (python2 Khondoker.py) Next login facebook Start Cloning\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ...mKHONDOKAR-IMRAN ....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                FB link👇🖕👇👇🖕
...
def pilih_hack():
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mJAM-SHAHRUKH\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---DevelopedBy Khondokar-imran--•◈•---»" #Dev:Jam_Shahrukh
	print '\033[1;95mProcess Has Been Completed Press➡ Type 0 Enter↩ Next Type 0 (logout)↩\033[1;97m....'
        print '\033[1;95mNext Type (python2 Khondoker.py) Next login facebook Start Cloning\033[1;97m....'
...
•\033[1;97m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;94m .....mKHONDOKAR-IMRAN ...... \033[1;97m :
•\033[1;97m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook  link:
              \033[1;94m Khondokar.Imran273"""
...
def clone_dari_member_group():
	...
	print"\033[1;96m[+] \033[1;92mFile Khondokar-Imran\033[1;91m:\033[1;97m out/GrupMailVuln.txt"
	raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
	crack()
...
def pilih_phone():
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mkhondokar-imran\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By KHONDOKAR-IMRAN •◈•---»" #Dev:KHONDOKAR-IMRAN 
	print '\033[1;95mProcess Has Been Completed Press➡ Type 0 Enter↩ Next Type 0 (logout)↩\033[1;97m....'
        print '\033[1;95mNext Type (python2 Khondoker.py) Next login facebook Start Cloning\033[1;97m....'
	print"\033[1;92mTotal Live/\x1b[1;91mError \033[1;93m: \033[1;91m"+str(len(oks))+"\033[1;93m/\033[1;96m"+str(len(cekpoint))
...
def pilih_mail():
	...
	if peak =="":
		...
		print logo
		idt = raw_input("\033[1;97m[•◈•] \033[1;94mEnter ID\033[1;97m: \033[1;97m")
		print "\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;93mKhomdokar-imram\033[1;97m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print"\033[1;97mName\033[1;97m:\033[1;94m "+op["name"]
...
def pilih_isi():
	...
	print "\033[1;97m«--------------------\033[1;92m▣\033[1;97m--------------------»"
	jalan(' \033[1;93mPlz Wait Cloned Accounts Will Appear Here')
        jalan(' \033[1;95m          Start Cloning KHONDOKAR-IMRAN ')
	print "\033[1;97m«--------------------\033[1;92m▣\033[1;97m--------------------»"
